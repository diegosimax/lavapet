<?php    
    ...
    while($row = $stmt->fetch()){  
        ...
        data-id='".$row["id_fornecedor"]."' data-nome='".utf8_encode($row["nome"])."' 
        ...
        data-cidade='".utf8_encode($row["cidade"])."' data-cep='".$row["cep"]."' data-cnpj='".$row["cnpj"]."'
        ...
        echo "<td>";        
        echo "<a href='#' class='pegaId' data-toggle='modal' data-target='#modal-excluir' data-id='".$row["id_fornecedor"]."' data-nome='".utf8_encode($row["nome"])."'><img src='../dist/img/delete.png' title='Excluir Fornecedor'></a>";
        echo "</td>";    
        echo "</tr>";               
    }    
