...
?>
  ...
  <head>
    ...
    <title><?=$GLOBALS["nomeEmpresa"]?> | Clientes</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
                ...
                <!-- Custom Tabs -->
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      ...
                      <li><a href="#" data-toggle="modal" data-target="#modal-inserir" title="Inserir Cliente"><img src="../dist/img/adicionar.png"></a></li>                                            
                    </ul>
                    <div class="tab-content">
                      <div class="tab-pane active" id="tab_1" align="left">
                        <table id="tabelaClientes" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                          <thead>
                            <tr>                             
                              <th>Nome</th>
                              <th>E-mail</th> 
                          ...
                          <tbody>
                            <?php require_once('../inc/clienteListar.php'); ?> 
                          </tbody>
                        </table>
                      </div>
                      <!-- /.tab-pane -->                      
      ...
      <div class="modal fade" id="modal-inserir">
        <div class="modal-dialog">
          <div class="modal-content">
            <form id="formInserirCliente" method="post" enctype="multipart/form-data" >  
                ...
                <div class="row" align="center">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label>CPF</label>
                                <input type="text" id="cpf" name="cpf" class="form-control" placeholder="999.999.999-99"><br>
                            </div>                
                            <div class="col-xs-6">
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Editar <label id="nomeClienteEditar" name="nomeClienteEditar"></label></h4>
            </div>
            <div class="modal-body">
              <div class="row" align="center">
                <div class="col-md-12">                                     
                    <img src="" width="200px" class="img-circular" name="imagemE" id="imagemE">
                    <input type="hidden" id="imagemCliente" name="imagemCliente" value="">
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-xs-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label>CPF</label>
                            <input type="text" id="cpfE" name="cpfE" class="form-control" placeholder="999.999.999-99"><br>
                        </div>                
                        <div class="col-xs-6">
                        </div>
                    </div>
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-info pull-right" >Salvar</button>
              <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Fechar</button> 
              <input type="hidden" value="" name="idClienteE" id="idClienteE">
            </div>
          </div>
          <!-- /.modal-content -->
          </form>
      ...
      <div class="modal fade" id="modal-excluir">
        <form id="formExcluirCliente" method="post" action="../inc/clienteExcluir.php">
          <div class="modal-dialog">            
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              <div class="row" align="center">
                <div class="col-md-12">                  
                    <label>Você tem certeza que deseja excluir o cliente<br><label id="nomeClienteExcluir" name="nomeClienteExcluir"></label>?</label>                    
                </div>
                <!-- /.col -->
              </div>
            </div>
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Fechar</button>                                  
              <input type="hidden" value="" name="idClienteExcluir" id="idClienteExcluir">
            </div>
          </div>
          <!-- /.modal-content -->
          </div>
      ...
      $(document).ready(function () {
        var table = $('#tabelaClientes').DataTable({
          ...
          buttons: [ 
            ...
            {
                extend: 'excelHtml5',
                title: 'Clientes <?=$GLOBALS["nomeEmpresa"]?>',
                exportOptions: {
                        columns: [ 0, 1, 2, 3 ]
                }
            }, 
        ...
        table.buttons().container()
          .appendTo('#tabelaClientes_wrapper .col-sm-6:eq(0)');
      });
    </script>
    <!-- JQUERY AJAX -->
    <script> 
    $(document).ready(function(){       
        $('#formInserirCliente').submit(function(){    
            
            var formData = new FormData(this);
            
            $('#resInserirCliente').html("<b>Processando...</b>");
            
            $.ajax({
                url: '../inc/clienteInserir.php', 
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
